...
| `references/` | Frameworks (`3ms-framework.md`), the AI primer (`ai-basics.md`), redstone analogies (`redstone-model.md`), voice samples, tool guides as you build them. |
...
> *Your AIOS structure should stay clean and well-run — not a hoarder's basement. When you can't find something, that's a signal to consolidate, not to add another folder.*
