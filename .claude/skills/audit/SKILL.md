...
| Layer | Test |
|---|---|
| **Context** | Knows you — who you are, what you're making, your voice, decisions, references |
...
- **Need to reach one of your tools?** Prefer API+script (write `scripts/{tool}_api.py` + save `references/{tool}-api.md`). Recommend `claude mcp add` only if no API path exists.
