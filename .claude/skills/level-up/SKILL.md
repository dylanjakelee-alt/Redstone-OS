...
4. *"If your project suddenly blew up — tons of players or attention — what would break or overwhelm you first?"* (constraint)
5. *"What's the one thing that would move your project forward the fastest right now?"* (leverage)
